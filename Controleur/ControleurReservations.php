...
// Ajoute un reservation à un plans_vol
    public function ajouter() {
        $reservation['plans_vol_id'] = $this->requete->getParametreId("plans_vol_id");
        ...
        if ($validation_courriel) {
            ...
            $this->rediriger('Plans_vols', 'lire/' . $reservation['plans_vol_id']);
        } else {
